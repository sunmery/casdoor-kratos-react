...
func (c *casdoorClient) Signin(ctx context.Context, in *SigninRequest, opts ...grpc.CallOption) (*SigninReply, error) {
	out := new(SigninReply)
	err := c.cc.Invoke(ctx, Casdoor_Signin_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *casdoorClient) Userinfo(ctx context.Context, in *UserinfoRequest, opts ...grpc.CallOption) (*UserinfoReply, error) {
	...
	err := c.cc.Invoke(ctx, Casdoor_Userinfo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedCasdoorServer must be embedded to have forward compatible implementations.
